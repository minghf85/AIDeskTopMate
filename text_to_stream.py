...
class TextToAudioStream:
    def __init__(
        ...
        # RMS related attributes for lip sync
    ...
    def GetRms(self) -> float:
        """
        Get the current RMS (Root Mean Square) value of the audio stream.
        This is used for lip synchronization with Live2D models.
        
        Returns:
            float: The current RMS value between 0.0 and 1.0
        """
